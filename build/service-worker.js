...
(0,workbox_routing__WEBPACK_IMPORTED_MODULE_2__.registerRoute)(function (_a) {
    var request = _a.request;
    return request.mode === "navigate" && request.method === "GET";
}, navigateFallback, "GET");
// Cache all necessary assets with Workbox. Asset list is generated by webpack and injected here.
(0,workbox_precaching__WEBPACK_IMPORTED_MODULE_1__.precacheAndRoute)([{'revision':'c92b85a5b907c70211f4ec25e29a8c4a','url':'favicon.ico'},{'revision':'460df70fe5601fc7abac7961c82f3193','url':'index.html'},{'revision':'33dbdd0177549353eeeb785d02c294af','url':'logo192.png'},{'revision':'917515db74ea8d1aee6a246cfbcc0b45','url':'logo512.png'},{'revision':'8190f715f29bad87536260474ab936e9','url':'manifest.json'}]);
...
// offline.
function navigateFallback(args) {
    return __awaiter(this, void 0, void 0, function () {
        var defaultFallbackUrl, fetchedResponse, fetchTimeout, controller, signal, cancelFetch, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    defaultFallbackUrl = "/index.html";
                    fetchTimeout = 2500;
                    controller = new AbortController();
                    signal = controller.signal;
                    cancelFetch = __webpack_require__.g.setTimeout(function () { return controller.abort(); }, fetchTimeout);
                    _a.label = 1;
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    console.debug("Attempting to fetch ".concat(args.request.url, "."));
                    return [4 /*yield*/, fetch(args.request.url, { signal: signal })];
                case 2:
                    fetchedResponse = _a.sent();
                    return [3 /*break*/, 4];
                case 3:
                    error_1 = _a.sent();
                    console.warn("Fetch Error: ".concat(error_1));
                    return [3 /*break*/, 4];
                case 4:
                    clearTimeout(cancelFetch);
                    if (!!(fetchedResponse === null || fetchedResponse === void 0 ? void 0 : fetchedResponse.ok)) return [3 /*break*/, 6];
                    console.debug("Failed to fetch ".concat(args.request.url, ". Serving ").concat(defaultFallbackUrl, " from cache."));
                    return [4 /*yield*/, (0,workbox_precaching__WEBPACK_IMPORTED_MODULE_1__.matchPrecache)(defaultFallbackUrl)];
                case 5:
                    fetchedResponse = _a.sent();
                    _a.label = 6;
                case 6: return [2 /*return*/, fetchedResponse || Response.error()];
            }
        });
    });
}
